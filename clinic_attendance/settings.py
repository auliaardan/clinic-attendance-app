...
TELEGRAM_ALERTS_ENABLED = env.bool("TELEGRAM_ALERTS_ENABLED", default=False)
TELEGRAM_BOT_TOKEN = env("TELEGRAM_BOT_TOKEN", default="")
TELEGRAM_CHAT_IDS = env("TELEGRAM_CHAT_IDS", default="")
ATTENDANCE_ALERT_DAILY_SUMMARY_TIME = env("ATTENDANCE_ALERT_DAILY_SUMMARY_TIME", default="18:00")
ATTENDANCE_ALERT_REQUEST_LOOKBACK_DAYS = env.int("ATTENDANCE_ALERT_REQUEST_LOOKBACK_DAYS", default=7)
ATTENDANCE_ALERT_HTTP_TIMEOUT_SECONDS = env.int("ATTENDANCE_ALERT_HTTP_TIMEOUT_SECONDS", default=10)
